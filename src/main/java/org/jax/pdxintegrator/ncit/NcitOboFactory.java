...
/**
 * Factory class for constructing {@link NcitTerm} and {@link NcitTermRelation} objects from
 ...
 * @version 0.1.1
 */
public class NcitOboFactory implements OboOntologyEntryFactory<NcitTerm, NcitTermRelation> {
    ...
    @Override
    public NcitTerm constructTerm(Stanza stanza) {
        final TermId id =
        ...
        return new NcitTerm(id, altTermIds, name, definition, comment, subsets, synonyms, obsolete,
    ...
    @Override
    public NcitTermRelation constructTermRelation(Stanza stanza, StanzaEntryIsA stanzaEntry) {
        final TermId sourceId =
                termIds.get(this.<StanzaEntryId>getCardinalityOneEntry(stanza, StanzaEntryType.ID).getId());
        final TermId destId = termIds.get(stanzaEntry.getId());
        return new NcitTermRelation(sourceId, destId, nextRelationId++, NcitRelationQualifier.IS_A);
    }

    @Override
    public NcitTermRelation constructTermRelation(Stanza stanza, StanzaEntryDisjointFrom stanzaEntry) {
        throw new UnsupportedOperationException();
    }

    @Override
    public NcitTermRelation constructTermRelation(Stanza stanza, StanzaEntryUnionOf stanzaEntry) {
        throw new UnsupportedOperationException();
    }

    @Override
    public NcitTermRelation constructTermRelation(Stanza stanza,
                                                 StanzaEntryIntersectionOf stanzaEntry) {
        throw new UnsupportedOperationException();
    }

    @Override
    public NcitTermRelation constructTermRelation(Stanza stanza, StanzaEntryRelationship stanzaEntry) {
        throw new UnsupportedOperationException();
    }
}
