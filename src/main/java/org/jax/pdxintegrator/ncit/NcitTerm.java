...
public class NcitTerm implements Term {
     ...
     */
    public NcitTerm(TermId id, List<TermId> altTermIds, String name, String definition, String comment,
    ...
    public String toString() {
        return "NCITTerm [id=" + id + ", altTermIds=" + altTermIds + ", name=" + name + ", definition="
